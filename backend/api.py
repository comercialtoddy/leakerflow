...
allowed_origins = ["https://www.leaker-flow.com", "https://leaker-flow.com"]
...
if config.ENV_MODE == EnvMode.STAGING:
    allowed_origins.append("https://staging.leaker-flow.com")
    allowed_origins.append("http://localhost:3000")
    allow_origin_regex = r"https://leaker-flow-.*-prjcts\.vercel\.app"
